  ...
  en: {
    translation: {
      ...
      scanner: {
        ...
        generateReportError: 'Failed to generate diagnosis report. Please try again.',
        analysisError: 'Error analyzing crop leaf. Please ensure leaf is clearly visible.'
      },
      market: {
        ...
        searchCrop: 'Search crop (e.g. Paddy, Tomato, Chilli)...',
        cropName: 'Crop Name',
        minPrice: 'Min Price',
        maxPrice: 'Max Price',
      ...
      weather: {
        ...
        loading: 'Fetching weather forecast...',
      ...
      assistant: {
        ...
        fallbackReply: 'I am experiencing a temporary connection issue. Please try asking again in a moment.',
        voiceHeader: 'AI Voice Assistant',
        voiceSubheader: 'Ask farming questions using voice in your preferred language',
        thinking: 'KrishiDrishti AI is thinking...',
      ...
      helpline: {
        title: 'Emergency Helpline & Expert Assistance',
        subtitle: 'Connect with national farmer call centers and emergency agricultural experts',
        kisanCenterTitle: 'Kisan Call Center (National)',
        kisanCenterDesc: 'Toll-free 24/7 agricultural advice from government agronomy experts',
        financialHelpline: 'PM-KISAN Financial Support Helpline',
        vetCare: 'Veterinary Emergency & Livestock Care',
        weatherEmergency: 'Disaster & Weather Alert Emergency',
        callNow: 'Call Now'
      },
      auth: {
      ...
      data: {
        ...
        weatherAlerts: [
          { title: 'Moderate Rainfall Expected', description: 'Rain showers predicted over next 24 hours (65% chance). Delay pesticide spraying.' },
          { title: 'Optimal Soil Moisture', description: 'Current humidity levels (78%) are favorable for paddy and chilli seedling growth.' }
        ],
        schemes: {
          'pm-kisan': {
            ...
            eligibility: ['All landholding farmers families across India', 'Subject to exclusion criteria (e.g. institutional landholders)'],
            benefits: ['₹6,000 per year directly transferred to bank accounts in 3 installments of ₹2,000', 'Direct Benefit Transfer (DBT) ensuring transparency'],
            documents: ['Aadhaar Card', 'Land Ownership Papers (RoR)', 'Active Bank Account linked with Aadhaar', 'Mobile Number']
          },
          'pmfby': {
            ...
            benefits: ['Low premium: 2% Kharif, 1.5% Rabi, 5% horticultural crops', 'Balance premium subsidized by Government', 'Full insured claim for crop loss'],
            documents: ['Land Records (Khasra/Khatauni)', 'Sowing Certificate', 'Aadhaar Card & Bank Passbook', 'Cancelled Cheque']
          },
          'kcc': {
            title: 'Kisan Credit Card (KCC) Scheme',
            overview: 'Provides timely and adequate short-term credit to farmers for crop cultivation and post-harvest expenses.',
            eligibility: ['Individual farmers / Joint borrowers', 'Tenant farmers and sharecroppers', 'Self Help Groups (SHGs)'],
            benefits: ['Concessional interest rate of 7% per annum for loans up to ₹3 Lakhs', '3% interest subvention for prompt repayment', 'Collateral-free loan up to ₹1.6 Lakhs'],
            documents: ['Application Form', 'Identity Proof (Aadhaar/Voter ID)', 'Address & Land Records', 'Passport Photographs']
          },
          'pmksy': {
            title: 'Pradhan Mantri Krishi Sinchayee Yojana (PMKSY)',
            overview: 'Promotes "Per Drop More Crop" micro-irrigation (Drip and Sprinkler) to improve water-use efficiency.',
            eligibility: ['Farmers owning cultivated land with assured water source'],
            benefits: ['55% subsidy for small/marginal farmers and 45% for other farmers on micro-irrigation', 'Reduced water consumption by 30-50%'],
            documents: ['Land Ownership Documents', 'Water Source Proof', 'Aadhaar & Bank Details']
          },
          'mky': {
            ...
            eligibility: ['Women farmers, women Self Help Groups (SHGs), and marginal women workers'],
            benefits: ['100% capacity building, organic farming training, and skill development', 'Financial seed capital for women-led enterprises'],
          ...
          'didf': {
            ...
            eligibility: ['Dairy Cooperative Societies, Milk Producer Companies, State Federations'],
            benefits: ['Subsidized loan interest rate at 6.5% per annum', 'Creation of milk chilling infrastructure in rural hubs'],
            documents: ['Registration Certificate of Cooperative', 'Detailed Project Report (DPR)', 'Bank Account Details']
          },
          'pmmsy': {
            ...
            eligibility: ['Fishers, fish farmers, fish workers, and fisheries cooperatives'],
            benefits: ['40% financial subsidy for General category and 60% for SC/ST/Women', 'Insurance coverage up to ₹5 Lakhs'],
            documents: ['Aadhaar Card', 'Fisheries License / Land ownership', 'Bank Details']
          },
          'rythu-bharosa': {
            ...
            eligibility: ['Farmer families owning land and registered tenant farmers in AP'],
            benefits: ['₹13,500 annually in 3 installments (₹7,500 Kharif, ₹4,000 Rabi, ₹2,000 Sankranti)'],
            documents: ['Aadhaar Card', 'AP Pattadar Passbook / CCRC Card', 'Bank Passbook']
          },
          'rythu-bandhu': {
            ...
            eligibility: ['All Pattadar land-owning farmers in Telangana state'],
            benefits: ['₹5,000 per acre for Kharif season + ₹5,000 per acre for Rabi season'],
            documents: ['Telangana Pattadar Passbook', 'Aadhaar Card', 'Bank Account Details']
          }
        },
        shops: {
          's1': { name: 'Sri Lakshmi Agri Inputs & Fertilizer Store', address: 'Main Road, Near APMC Market Yard, Guntur, AP 522001' },
          's2': { name: 'Kisan Crop Protection & Pesticides Center', address: 'Station Road, Guntur, AP 522002' },
          's3': { name: 'Rythu Seva Kendram & Farm Equipment Store', address: 'RTC Bus Stand Complex, Guntur, AP 522001' },
          's4': { name: 'Jai Kisan Organic Fertilizers & Seeds Depot', address: 'Enamamula Market Road, Warangal, TS 506002' },
          's5': { name: 'Cauvery Agri Tech & Drip Equipment', address: 'APMC Yard Gate, Kolar, KA 563101' }
        }
      }
    }
  },
  te: {
    translation: {
      ...
      market: {
        ...
        searchCrop: 'పంట పేరుతో వెతకండి (ఉదా: వరి, టమాటో, మిరప)...',
        cropName: 'పంట పేరు',
        minPrice: 'కనీస ధర',
        maxPrice: 'గరిష్ట ధర',
      ...
      weather: {
        ...
        loading: 'వాతావరణ వివరాలు లోడ్ అవుతున్నాయి...',
      ...
      assistant: {
        ...
        fallbackReply: 'తాత్కాలిక సాంకేతిక సమస్య వచ్చింది. దయచేసి కాసేపటి తర్వాత మళ్ళీ ప్రయత్నించండి.',
        voiceHeader: 'AI వాయిస్ సహాయకుడు',
        voiceSubheader: 'మీ మాతృభాషలో వాయిస్‌తో వ్యవసాయ సందేహాలు అడగండి',
        thinking: 'కృషిదృష్టి AI ఆలోచిస్తోంది...',
        speakNow: 'మీ ప్రశ్నను ఇప్పుడు చెప్పండి...',
        stopListening: 'వినడం ఆపండి',
        tapToSpeak: 'మాట్లాడటానికి మైక్ నొక్కండి',
        muteSpeech: 'శబ్దం ఆపండి',
        quickPrompts: [
          'వరి పంటకు ఎరువుల యాజమాన్యం',
          'టమాటోలో లేట్ బ్లైట్ నివారణ',
          'PM-KISAN అర్హత వివరాలు',
          'తెల్లనల్లికి సేంద్రీయ నివారణ'
        ]
      },
      helpline: {
        title: 'అత్యవసర సహాయం & నిపుణుల సలహాలు',
        subtitle: 'జాతీయ రైతు కాల్ సెంటర్ మరియు వ్యవసాయ అధికారులతో మాట్లాడండి',
        kisanCenterTitle: 'కిసాన్ కాల్ సెంటర్ (జాతీయ ఉచిత సేవ)',
        kisanCenterDesc: '24/7 ప్రభుత్వ వ్యవసాయ నిపుణుల ఉచిత సలహాలు',
        financialHelpline: 'PM-KISAN ఆర్థిక సహాయం హెల్ప్‌లైన్',
        vetCare: 'పశువైద్య అత్యవసర కేంద్రం',
        weatherEmergency: 'వాతావరణ హెచ్చరికలు & విపత్తు నిర్వహణ',
        callNow: 'కాల్ చేయండి'
      },
      auth: {
      ...
      // Data translation maps (Telugu Script)
      data: {
        states: {
        ...
        weatherAlerts: [
          { title: 'మోస్తరు వర్షపాతం హెచ్చరిక', description: 'రాబోయే 24 గంటల్లో వర్షం కురిసే అవకాశం ఉంది. మందుల పిచికారీని నిలిపివేయండి.' },
          { title: 'అనుకూలమైన మట్టి తేమ', description: 'ప్రస్తుత తేమ శాతం (78%) వరి నారుమళ్లకు మరియు మిరప మొక్కల ఎదుగుదలకు అనుకూలం.' }
        ],
        schemes: {
          'pm-kisan': {
            ...
            eligibility: ['భారతదేశంలోని సాగుభూమి కలిగిన రైతు కుటుంబాలన్నీ అర్హులు', 'ఆదాయపు పన్ను చెల్లించేవారు మినహాయింపు'],
            benefits: ['ఏటా ₹6,000 నేరుగా బ్యాంక్ ఖాతాలో జమ (₹2,000 చొప్పున 3 విడతలు)', '100% పారదర్శకతతో DBT పద్ధతి'],
            documents: ['ఆధార్ కార్డ్', 'భూమి హక్కు పత్రాలు (పట్టాదార్ పాస్ పుస్తకం)', 'ఆధార్ లింక్ అయిన బ్యాంక్ ఖాతా', 'ఫోన్ నంబర్']
          },
          'pmfby': {
            ...
            eligibility: ['నోటిఫై చేసిన పంటలను సాగుచేసే రైతులు, కౌలు రైతులందరూ అర్హులు'],
            benefits: ['చాలా తక్కువ ప్రీమియం: ఖరీఫ్‌కు 2%, రబీకి 1.5%, వాణిజ్య పంటలకు 5%', 'మిగిలిన ప్రీమియంను ప్రభుత్వమే భరిస్తుంది'],
            documents: ['భూమి పత్రాలు (ఖాతా/పహాణీ)', 'పంట విత్తిన ధృవీకరణ పత్రం', 'ఆధార్ కార్డ్ & బ్యాంక్ పాస్ బుక్', 'కాన్సల్డ్ చెక్']
          },
          'kcc': {
            ...
            eligibility: ['సొంత భూమి కలిగిన రైతులు, కౌలు రైతులు', 'రైతు స్వయం సహాయక బృందాలు (SHG)'],
            benefits: ['₹3 లక్షల వరకు సంవత్సరానికి కేవలం 7% వడ్డీకే రుణం', 'సకాలంలో చెల్లిస్తే 3% వడ్డీ రాయితీ (సరిగ్గా కడితే 4% వడ్డీ)', '₹1.6 లక్షల వరకు షూరిటీ లేని రుణం'],
            documents: ['దరఖాస్తు ఫారం', 'గుర్తింపు కార్డు (ఆధార్/ఓటర్ ఐడీ)', 'చిరునామా & భూమి పత్రాలు', 'పాస్‌పోర్ట్ సైజు ఫొటోలు']
          },
          'pmksy': {
            ...
            eligibility: ['సాగుభూమి మరియు నీటి వసతి కలిగిన రైతులందరూ అర్హులు'],
            benefits: ['చిన్న, సన్నకారు రైతులకు 55% మరియు ఇతర రైతులకు 45% సబ్సిడీ', '30-50% నీటి పొదుపు మరియు ఎరువుల ఆదా'],
            documents: ['భూమి యాజమాన్య పత్రాలు', 'నీటి వసతి ఆధారాలు', 'ఆధార్ & బ్యాంక్ వివరాలు']
          },
          'mky': {
            ...
            eligibility: ['మహిళా రైతులు, మహిళా సంఘాల సభ్యులు (SHG)'],
            benefits: ['సేంద్రీయ వ్యవసాయంపై 100% ఉచిత శిక్షణ', 'మహిళా రైతు గ్రూపులకు ఆర్థిక ప్రోత్సాహకాలు'],
            documents: ['ఆధార్ కార్డ్', 'మహిళా సంఘం సభ్యత్వ కార్డ్', 'బ్యాంక్ ఖాతా వివరాలు']
          },
          'didf': {
            ...
            eligibility: ['పాడి సహకార సంఘాలు, పాల ఉత్పత్తిదారుల సంఘాలు'],
            benefits: ['6.5% తక్కువ వడ్డీకే రుణాలు', 'గ్రామీణ ప్రాంతాల్లో పాల శీతలీకరణ కేంద్రాల ఏర్పాటు'],
            documents: ['సంఘం రిజిస్ట్రేషన్ సర్టిఫికేట్', 'ప్రాజెక్ట్ నివేదిక (DPR)', 'బ్యాంక్ ఖాతా వివరాలు']
          },
          'pmmsy': {
            title: 'ప్రధాన మంత్రి మత్స్య సంపద యోజన (PMMSY)',
            overview: 'చేపలు మరియు రొయ్యల పెంపకం దారులకు ఆర్థిక సహాయం మరియు నిధులు.',
            eligibility: ['మత్స్యకారులు, చేపల పెంపకందారులు, సహకార సంఘాలు'],
            benefits: ['జనరల్ వర్గానికి 40%, SC/ST/మహిళలకు 60% ఆర్థిక సబ్సిడీ', '₹5 లక్షల వరకు ప్రమాద భీమా రక్షణ'],
            documents: ['ఆధార్ కార్డ్', 'చేపల పెంపకం లైసెన్స్/చెరువు భూమి పత్రాలు', 'బ్యాంక్ వివరాలు']
          },
          'rythu-bharosa': {
            ...
            eligibility: ['ఆంధ్రప్రదేశ్ లోని సొంత భూమి కలిగిన రైతులు మరియు CCRC కౌలు రైతులు'],
            benefits: ['ఏటా ₹13,500 ఆర్థిక సాయం (ఖరీఫ్ ముందు ₹7,500, రబీ ముందు ₹4,000, సంక్రాంతికి ₹2,000)'],
            documents: ['ఆధార్ కార్డ్', 'పట్టాదార్ పాస్ పుస్తకం / CCRC కౌలు కార్డ్', 'బ్యాంక్ పాస్ బుక్']
          },
          'rythu-bandhu': {
            title: 'రైతు బంధు పథకం (తెలంగాణ)',
            overview: 'తెలంగాణలోని పట్టాదారు రైతులకు ఎకరానికి ఏటా ₹10,000 పెట్టుబడి సాయం అందించే పథకం.',
            eligibility: ['తెలంగాణలోని పట్టాదారు రైతులందరూ అర్హులు'],
            benefits: ['ఎకరానికి ఖరీఫ్‌లో ₹5,000 + రబీలో ₹5,000 నేరుగా బ్యాంక్ ఖాతాలో జమ'],
            documents: ['తెలంగాణ పట్టాదార్ పాస్ పుస్తకం', 'ఆధార్ కార్డ్', 'బ్యాంక్ ఖాతా వివరాలు']
          }
        },
        shops: {
          's1': { name: 'శ్రీ లక్ష్మి అగ్రి ఇన్‌పుట్స్ & ఫెర్టిలైజర్ స్టోర్', address: 'మెయిన్ రోడ్, APMC మార్కెట్ యార్డ్ దగ్గర, గుంటూరు, AP 522001' },
          's2': { name: 'కిసాన్ క్రాప్ ప్రొటెక్షన్ & పెస్టిసైడ్స్ సెంటర్', address: 'స్టేషన్ రోడ్, గుంటూరు, AP 522002' },
          's3': { name: 'రైతు సేవా కేంద్రం & ఫార్మ్ ఎక్విప్‌మెంట్ స్టోర్', address: 'RTC బస్ స్టాండ్ కాంప్లెక్స్, గుంటూరు, AP 522001' },
          's4': { name: 'జై కిసాన్ ఆర్గానిక్ ఫెర్టిలైజర్స్ & సీడ్స్ డిపో', address: 'ఏనుమాముల మార్కెట్ రోడ్, వరంగల్, TS 506002' },
          's5': { name: 'కావేరి అగ్రి టెక్ & డ్రిప్ ఎక్విప్‌మెంట్', address: 'APMC యార్డ్ గేట్, కోలార్, KA 563101' }
        }
      }
    }
  },
  hi: {
    translation: {
      ...
      market: {
        ...
        searchCrop: 'फसल खोजें (जैसे गेहूं, धान, टमाटर)...',
        cropName: 'फसल का नाम',
      ...
      // Data translation maps (Hindi Script)
      data: {
        states: {
        ...
        weatherAlerts: [
          { title: 'मध्यम बारिश की चेतावनी', description: 'अगले 24 घंटों में बारिश की संभावना है। कीटनाशक छिड़काव स्थगित रखें।' },
          { title: 'अनुकूल मिट्टी की नमी', description: 'वर्तमान आद्रता (78%) धान की पौध और मिर्च के पौधों की वृद्धि के लिए अनुकूल है।' }
        ],
        schemes: {
          'pm-kisan': {
            ...
            eligibility: ['भारत के सभी योग्य भूमिधारक किसान परिवार', 'उच्च आय करदाताओं को छोड़कर'],
            benefits: ['₹6,000 प्रति वर्ष 3 समान किस्तों (₹2,000) में सीधे बैंक खाते में', 'पारदर्शिता के साथ DBT हस्तांतरण'],
            documents: ['आधार कार्ड', 'भूमि मालिकाना दस्तावेज (खसरा/खतौनी)', 'आधार लिंक बैंक खाता', 'मोबाइल नंबर']
          },
          'pmfby': {
            ...
            eligibility: ['अधिसूचित क्षेत्रों में अधिसूचित फसल उगाने वाले सभी किसान एवं बटाईदार'],
            benefits: ['कम प्रीमियम: खरीफ 2%, रबी 1.5%, व्यावसायिक फसलें 5%', 'शेष प्रीमियम सरकार द्वारा वहन', 'फसल नुकसान का पूरा बीमा दावा'],
            documents: ['भूमि रिकॉर्ड (खसरा/खतौनी)', 'बुआई प्रमाण पत्र', 'आधार कार्ड एवं बैंक पासबुक', 'रद्द चेक']
          },
          'kcc': {
            ...
            eligibility: ['व्यक्तिगत किसान / संयुक्त खातेदार', 'पट्टेदार किसान एवं बटाईदार', 'स्वयं सहायता समूह (SHG)'],
            benefits: ['₹3 लाख तक के ऋण पर 7% रियायती ब्याज दर', 'समय पर भुगतान करने पर 3% की अतिरिक्त छूट (प्रभावी ब्याज 4%)', '₹1.6 लाख तक बिना गारंटी ऋण'],
            documents: ['आवेदन पत्र', 'पहचान पत्र (आधार/वोटर आईडी)', 'पता एवं भूमि रिकॉर्ड', 'पासपोर्ट फोटो']
          },
          'pmksy': {
            ...
            eligibility: ['सिंचाई योग्य भूमि और जल स्रोत वाले किसान'],
            benefits: ['छोटे/सीमांत किसानों को 55% और अन्य किसानों को 45% सब्सिडी', '30-50% जल की बचत'],
            documents: ['भूमि स्वामित्व दस्तावेज', 'जल स्रोत का प्रमाण', 'आधार एवं बैंक विवरण']
          },
          'mky': {
            ...
            eligibility: ['महिला किसान, महिला स्वयं सहायता समूह (SHG)'],
            benefits: ['जैविक खेती पर 100% मुफ्त प्रशिक्षण', 'महिला समूहों को वित्तीय पूंजी सहायता'],
            documents: ['आधार कार्ड', 'SHG सदस्यता कार्ड', 'बैंक खाता विवरण']
          },
          'didf': {
            ...
            eligibility: ['डेयरी सहकारिता समितियां, दुग्ध उत्पादक कंपनियां'],
            benefits: ['6.5% रियायती ब्याज दर पर ऋण', 'ग्रामीण क्षेत्रों में मिल्क चिलिंग प्लांट की स्थापना'],
            documents: ['समिति पंजीकरण प्रमाण पत्र', 'परियोजना रिपोर्ट (DPR)', 'बैंक खाता विवरण']
          },
          'pmmsy': {
            ...
            eligibility: ['मछुआरे, मत्स्य पालक, सहकारी समितियां'],
            benefits: ['सामान्य वर्ग को 40% और SC/ST/महिलाओं को 60% वित्तीय सब्सिडी', '₹5 लाख तक का दुर्घटना बीमा'],
            documents: ['आधार कार्ड', 'मत्स्य पालन लाइसेंस/भूमि दस्तावेज', 'बैंक विवरण']
          },
          'rythu-bharosa': {
            ...
            eligibility: ['आंध्र प्रदेश के भूमिधारक किसान एवं पंजीकृत बटाईदार किसान'],
            benefits: ['प्रति वर्ष ₹13,500 की सहायता 3 किस्तों में'],
            documents: ['आधार कार्ड', 'पट्टादार पासबुक / CCRC कार्ड', 'बैंक पासबुक']
          },
          'rythu-bandhu': {
            title: 'रायथू बंधु योजना (तेलंगाना)',
            overview: 'तेलंगाना के किसानों को फसल निवेश सहायता के रूप में प्रति एकड़ ₹10,000 प्रति वर्ष।',
            eligibility: ['तेलंगाना के सभी पट्टादार किसान'],
            benefits: ['खरीफ में ₹5,000 + रबी में ₹5,000 प्रति एकड़ सीधे बैंक खाते में'],
            documents: ['तेलंगाना पट्टादार पासबुक', 'आधार कार्ड', 'बैंक खाता विवरण']
          }
        },
        shops: {
          's1': { name: 'श्री लक्ष्मी एग्री इनपुट्स एंड फर्टिलाइजर स्टोर', address: 'मेन रोड, APMC मार्केट यार्ड के पास, गुंटूर, AP 522001' },
          's2': { name: 'किसान क्रॉप प्रोटेक्शन एंड पेस्टिसाइड्स सेंटर', address: 'स्टेशन रोड, गुंटूर, AP 522002' },
          's3': { name: 'रायथू सेवा केंद्रम एंड फार्म इक्विपमेंट स्टोर', address: 'RTC बस स्टैंड कॉम्प्लेक्स, गुंटूर, AP 522001' },
          's4': { name: 'जय किसान ऑर्गेनिक फर्टिलाइजर्स एंड सीड्स डिपो', address: 'एनमामूला मार्केट रोड, वरंगल, TS 506002' },
          's5': { name: 'कावेरी एग्री टेक एंड ड्रिप इक्विपमेंट', address: 'APMC यार्ड गेट, कोलार, KA 563101' }
        }
      }
    }
  },
  ta: {
    translation: {
      ...
      market: {
        ...
        searchCrop: 'பயிரைத் தேடுக (எ.கா. நெல், தக்காளி, மிளகாய்)...',
      ...
      weather: {
        ...
        loading: 'வானிலை விவரங்கள் ஏற்றப்படுகின்றன...',
      ...
      // Data translation maps (Tamil Script)
      data: {
        states: {
        ...
        weatherAlerts: [
          { title: 'மிதமான மழை எச்சரிக்கை', description: 'அடுத்த 24 மணி நேரத்தில் மழை பெய்ய வாய்ப்புள்ளது. தெளிப்பை ஒத்திவைக்கவும்.' },
          { title: 'சாதகமான மண் ஈரப்பதம்', description: 'தற்போதைய ஈரப்பதம் (78%) நெல் மற்றும் மிளகாய் பயிர் வளர்ச்சிக்கு சாதகமானது.' }
        ],
        schemes: {
          'pm-kisan': {
            ...
            eligibility: ['இந்தியாவில் நிலம் வைத்துள்ள அனைத்து விவசாய குடும்பங்களும் தகுதியானவர்கள்'],
            benefits: ['ஆண்டுக்கு ₹6,000 3 தவணைகளில் (₹2,000) நேரடியாக வங்கிக் கணக்கில்', 'நேரடி பணப் பரிமாற்றம் (DBT) வெளிப்படைத்தன்மை'],
            documents: ['ஆதார் கார்டு', 'நில ஆவணங்கள் (பட்டா/சிட்டா)', 'ஆதாருடன் இணைக்கப்பட்ட வங்கி கணக்கு', 'மொபைல் எண்']
          },
          'pmfby': {
            ...
            eligibility: ['அறிவிக்கப்பட்ட பகுதிகளில் பயிர் செய்யும் அனைத்து விவசாயிகளும் தகுதியானவர்கள்'],
            benefits: ['குறைந்த பிரீமியம்: காரிஃப் 2%, ரபி 1.5%, தோட்டக்கலை 5%', 'மீதி பிரீமியம் அரசே செலுத்தும்', 'முழு இழப்பீடு தொகை'],
            documents: ['நில ஆவணங்கள்', 'பயிர் சாகுபடி சான்றிதழ்', 'ஆதார் கார்டு & வங்கி கணக்கு', 'ரத்து செய்யப்பட்ட காசோலை']
          },
          'kcc': {
            ...
            eligibility: ['தனிப்பட்ட விவசாயிகள் / குத்தகை விவசாயிகள்', 'சுய உதவிக்குழுக்கள் (SHG)'],
            benefits: ['₹3 லட்சம் வரையிலான கடன்களுக்கு 7% சலுகை வட்டி', 'முறையாகச் செலுத்தினால் 3% கூடுதல் வட்டி மானியம்', '₹1.6 லட்சம் வரை பிணையில்லா கடன்'],
            documents: ['விண்ணப்பப் படிவம்', 'அடையாளச் சான்று (ஆதார்/வாக்காளர் அடையாள அட்டை)', 'முகவரி & நில ஆவணங்கள்', 'பாஸ்போர்ட் அளவு புகைப்படம்']
          },
          'pmksy': {
            ...
            eligibility: ['பாசன வசதியுள்ள நில உரிமையாளர்கள்'],
            benefits: ['சிறிய/குறு விவசாயிகளுக்கு 55% மற்றும் பிற விவசாயிகளுக்கு 45% மானியம்', '30-50% நீர் சேமிப்பு'],
            documents: ['நில உரிமை ஆவணங்கள்', 'நீர் ஆதார சான்று', 'ஆதார் & வங்கி விவரங்கள்']
          },
          'mky': {
            ...
            eligibility: ['பெண் விவசாயிகள், மகளிர் சுய உதவிக்குழுக்கள் (SHG)'],
            benefits: ['இயற்கை விவசாயம் பற்றிய 100% இலவச பயிற்சி', 'மகளிர் குழுக்களுக்கு நிதி உதவி'],
            documents: ['ஆதார் கார்டு', 'சுய உதவிக்குழு உறுப்பினர் அட்டை', 'வங்கி கணக்கு விவரங்கள்']
          },
          'didf': {
            ...
            eligibility: ['பால் கூட்டுறவு சங்கங்கள், பால் உற்பத்தியாளர் நிறுவனங்கள்'],
            benefits: ['6.5% சலுகை வட்டியில் கடன்', 'கிராமப்புறங்களில் பால் குளிரூட்டும் மையங்கள் அமைத்தல்'],
            documents: ['கூட்டுறவு சங்க பதிவு சான்றிதழ்', 'திட்ட அறிக்கை (DPR)', 'வங்கி கணக்கு விவரங்கள்']
          },
          'pmmsy': {
            ...
            eligibility: ['மீனவர்கள், மீன் வளர்ப்போர், கூட்டுறவு சங்கங்கள்'],
            benefits: ['பொதுப்பிரிவினருக்கு 40% மற்றும் SC/ST/பெண்களுக்கு 60% நிதி மானியம்', '₹5 லட்சம் வரை விபத்து காப்பீடு'],
            documents: ['ஆதார் கார்டு', 'மீன்பிடி உரிமம்/நில ஆவணங்கள்', 'வங்கி விவரங்கள்']
          },
          'rythu-bharosa': {
            ...
            eligibility: ['ஆந்திராவில் நிலம் வைத்துள்ள விவசாயிகள் மற்றும் குத்தகை விவசாயிகள்'],
            benefits: ['ஆண்டுக்கு ₹13,500 3 தவணைகளில் நிதி உதவி'],
            documents: ['ஆதார் கார்டு', 'பட்டா தார் பாஸ்புக் / CCRC அட்டை', 'வங்கி பாஸ்புக்']
          },
          'rythu-bandhu': {
            title: 'ரைது பந்து திட்டம் (தெலங்கானா)',
            overview: 'தெலங்கானாவில் நில உரிமையாளர்களுக்கு ஏக்கரால் ஆண்டுக்கு ₹10,000 முதலீட்டு உதவி.',
            eligibility: ['தெலங்கானாவில் நிலம் வைத்துள்ள அனைத்து பட்டாதாரர்களும்'],
            benefits: ['ஏக்கருக்கு காரிஃப் ₹5,000 + ரபி ₹5,000 நேரடியாக வங்கிக் கணக்கில்'],
            documents: ['தெலங்கானா பட்டாதார் பாஸ்புக்', 'ஆதார் கார்டு', 'வங்கி கணக்கு விவரங்கள்']
          }
        },
        shops: {
          's1': { name: 'ஸ்ரீ லக்ஷ்மி அக்ரி இன்புட்ஸ் & உரக் கடை', address: 'முதன்மை சாலை, APMC சந்தை அருகில், குண்டூர், AP 522001' },
          's2': { name: 'கிசான் பயிர் பாதுகாப்பு & பூச்சிக்கொல்லி மையம்', address: 'ஸ்டேஷன் சாலை, குண்டூர், AP 522002' },
          's3': { name: 'ரைது சேவா கேந்திரம் & பண்ணை உபகரணங்கள் கடை', address: 'RTC பேருந்து நிலைய வளாகம், குண்டூர், AP 522001' },
          's4': { name: 'ஜெய் கிசான் இயற்கை உரங்கள் & விதைகள் மையம்', address: 'எனமாமுலா சந்தை சாலை, வாரங்கல், TS 506002' },
          's5': { name: 'காவேரி அக்ரி டெக் & சொட்டுநீர் உபகரணங்கள்', address: 'APMC யார்டு கேட், கோலார், KA 563101' }
        }
      }
    }
  },
  kn: {
    translation: {
      ...
      market: {
        ...
        searchCrop: 'ಬೆಳೆ ಹುಡುಕಿ (ಉದಾ: ಭತ್ತ, ಟೊಮೆಟೊ, ಮೆಣಸಿನಕಾಯಿ)...',
      ...
      weather: {
        ...
        loading: 'ಹವಾಮಾನ ವಿವರಗಳನ್ನು ಲೋಡ್ ಮಾಡಲಾಗುತ್ತಿದೆ...',
      ...
      // Data translation maps (Kannada Script)
      data: {
        states: {
        ...
        weatherAlerts: [
          { title: 'ಸಾಧಾರಣ ಮಳೆಯ ಎಚ್ಚರಿಕೆ', description: 'ಮುಂದಿನ 24 ಗಂಟೆಗಳಲ್ಲಿ ಮಳೆಯಾಗುವ ಸಾಧ್ಯತೆಯಿದೆ. ಸಿಂಪಡಣೆ ಮುಂದೂಡಿ.' },
          { title: 'ಸೂಕ್ತ ಮಣ್ಣಿನ ತೇವಾಂಶ', description: 'ಪ್ರಸ್ತುತ ತೇವಾಂಶ (78%) ಭತ್ತದ ಸಸಿಗಳಿಗೆ ಮತ್ತು ಮೆಣಸಿನಕಾಯಿ ಸಸಿಗಳ ಬೆಳವಣಿಗೆಗೆ ಪೂರಕವಾಗಿದೆ.' }
        ],
        schemes: {
          'pm-kisan': {
            ...
            eligibility: ['ಭಾರತದ ಎಲ್ಲಾ ಜಮೀನು ಹೊಂದಿರುವ ರೈತ ಕುಟುಂಬಗಳು ಅರ್ಹರು'],
            benefits: ['ವರ್ಷಕ್ಕೆ ₹6,000 ರಂತೆ 3 ಕಂತುಗಳಲ್ಲಿ (₹2,000) ನೇರ ಬ್ಯಾಂಕ್ ಜಮಾ', 'ಸುಲಭ ಮತ್ತು ಪಾರದರ್ಶಕ DBT ವರ್ಗಾವಣೆ'],
            documents: ['ಆಧಾರ್ ಕಾರ್ಡ್', 'ಜಮೀನಿನ ಪಹಣಿ (RTC)', 'ಆಧಾರ್ ಲಿಂಕ್ ಆದ ಬ್ಯಾಂಕ್ ಖಾತೆ', 'ಮೊಬೈಲ್ ಸಂಖ್ಯೆ']
          },
          'pmfby': {
            ...
            eligibility: ['ಅಧಿಸೂಚಿತ ಪ್ರದೇಶದಲ್ಲಿ ಅಧಿಸೂಚಿತ ಬೆಳೆ ಬೆಳೆಯುವ ಎಲ್ಲಾ ರೈತರು'],
            benefits: ['ಕಡಿಮೆ ಪ್ರೀಮಿಯಂ: ಮುಂಗಾರು 2%, ಹಿಂಗಾರು 1.5%, ವಾಣಿಜ್ಯ ಬೆಳೆಗಳು 5%', 'ಉಳಿದ ಪ್ರೀಮಿಯಂ ಸರ್ಕಾರವೇ ಭರಿಸುತ್ತದೆ'],
            documents: ['ಪಹಣಿ (RTC)', 'ಬಿತ್ತನೆ ದೃಢೀಕರಣ ಪತ್ರ', 'ಆಧಾರ್ ಕಾರ್ಡ್ & ಬ್ಯಾಂಕ್ ಪಾಸ್‌ಬುಕ್', 'ರದ್ದಾದ ಚೆಕ್']
          },
          'kcc': {
            ...
            eligibility: ['ವೈಯಕ್ತಿಕ ರೈತರು / ಜಂಟಿ ಖಾತೆದಾರರು', 'ಗೇಣಿ ರೈತರು', 'ಸ್ವಸಹಾಯ ಗುಂಪುಗಳು (SHG)'],
            benefits: ['₹3 ಲಕ್ಷದವರೆಗಿನ ಸಾಲಕ್ಕೆ ಬಾರ್ಷಿಕ 7% ರಿಯಾಯಿತಿ ಬಡ್ಡಿದರ', 'ಸಮಯಕ್ಕೆ ಸರಿಯಾಗಿ ಪಾವತಿಸಿದರೆ 3% ಬಡ್ಡಿ ಸಹಾಯಧನ', '₹1.6 ಲಕ್ಷದವರೆಗೆ ಶೂರಿಟಿ ಇಲ್ಲದ ಸಾಲ'],
            documents: ['ಅರ್ಜಿ ನಮೂನೆ', 'ಗುರುತಿನ ಚೀಟಿ (ಆಧಾರ್/ವೋಟರ್ ಐಡಿ)', 'ವಿಳಾಸ & ಪಹಣಿ ದಾಖಲೆಗಳು', 'ಪಾಸ್‌ಪೋರ್ಟ್ ಫೋಟೋ']
          },
          'pmksy': {
            ...
            eligibility: ['ನೀರಾವರಿ ಸೌಲಭ್ಯ ಹೊಂದಿರುವ ಜಮೀನಿನ ರೈತರು'],
            benefits: ['ಸಣ್ಣ/ಅಂಚಿನ ರೈತರಿಗೆ 55% ಮತ್ತು ಇತರೆ ರೈತರಿಗೆ 45% ಸಬ್ಸಿಡಿ', '30-50% ನೀರು ಉಳಿತಾಯ'],
            documents: ['ಜಮೀನಿನ ಹಕ್ಕು ದಾಖಲೆಗಳು', 'ನೀರಿನ ಮೂಲದ ಪುರಾವೆ', 'ಆಧಾರ್ & ಬ್ಯಾಂಕ್ ವಿವರಗಳು']
          },
          'mky': {
            ...
            eligibility: ['ಮಹಿಳಾ ರೈತರು, ಮಹಿಳಾ ಸ್ವಸಹಾಯ ಗುಂಪುಗಳು (SHG)'],
            benefits: ['ಸಾವಯವ ಕೃಷಿ ಕುರಿತು 100% ಉಚಿತ ತರಬೇತಿ', 'ಮಹಿಳಾ ಗುಂಪುಗಳಿಗೆ ಆರ್ಥಿಕ ಬಂಡವಾಳ ನೆರವು'],
            documents: ['ಆಧಾರ್ ಕಾರ್ಡ್', 'SHG ಸದಸ್ಯತ್ವ ಚೀಟಿ', 'ಬ್ಯಾಂಕ್ ಖಾತೆ ವಿವರಗಳು']
          },
          'didf': {
            ...
            eligibility: ['ಹಾಲಿನ ಸಹಕಾರ ಸಂಘಗಳು, ಹಾಲು ಉತ್ಪಾದಕರ ಕಂಪನಿಗಳು'],
            benefits: ['6.5% ರಿಯಾಯಿತಿ ಬಡ್ಡಿದರದಲ್ಲಿ ಸಾಲ ಸೌಲಭ್ಯ', 'ಗ್ರಾಮೀಣ ಭಾಗದಲ್ಲಿ ಹಾಲು ಶೀತಲೀಕರಣ ಕೇಂದ್ರ ಸ್ಥಾಪನೆ'],
            documents: ['ಸಂಘದ ನೋಂದಣಿ ಪ್ರಮಾಣಪತ್ರ', 'ಯೋಜನಾ ವರದಿ (DPR)', 'ಬ್ಯಾಂಕ್ ಖಾತೆ ವಿವರಗಳು']
          },
          'pmmsy': {
            title: 'ಪ್ರಧಾನಮಂತ್ರಿ ಮತ್ಸ್ಯ ಸಂಪದ ಯೋಜನೆ (PMMSY)',
            overview: 'ಮೀನುಗಾರಿಕೆ ಮತ್ತು ಮೀನು ಸಾಕಣೆ ಕೊಳಗಳ ಸಮಗ್ರ ಅಭಿವೃದ್ಧಿಗಾಗಿ ಆರ್ಥಿಕ ನೆರವು.',
            eligibility: ['ಮೀನುಗಾರರು, ಮೀನು ಸಾಲಿಕೆದಾರರು, ಸಹಕಾರ ಸಂಘಗಳು'],
            benefits: ['ಸಾಮಾನ್ಯ ವರ್ಗಕ್ಕೆ 40% ಮತ್ತು SC/ST/ಮಹಿಳೆಯರಿಗೆ 60% ಹಣಕಾಸಿನ ಸಬ್ಸಿಡಿ', '₹5 ಲಕ್ಷದವರೆಗೆ ಅಪಘಾತ ವಿಮೆ'],
            documents: ['ಆಧಾರ್ ಕಾರ್ಡ್', 'ಮೀನುಗಾರಿಕೆ ಪರವಾನಗಿ/ಜಮೀನಿನ ದಾಖಲೆ', 'ಬ್ಯಾಂಕ್ ವಿವರಗಳು']
          },
          'rythu-bharosa': {
            title: 'YSR ರೈತು ಭರೋಸಾ - PM KISAN (ಆಂಧ್ರಪ್ರದೇಶ)',
            overview: 'ಆಂಧ್ರಪ್ರದೇಶದ ರೈತರಿಗೆ ಮತ್ತು ಗೇಣಿ ರೈತರಿಗೆ ವರ್ಷಕ್ಕೆ ₹13,500 ಆರ್ಥಿಕ ನೆರವು.',
            eligibility: ['ಆಂಧ್ರಪ್ರದೇಶದ ಜಮೀನುದಾರರು ಮತ್ತು ನೋಂದಾಯಿತ ಗೇಣಿ ರೈತರು'],
            benefits: ['ವರ್ಷಕ್ಕೆ ₹13,500 ಹಣಕಾಸಿನ ಸಹಾಯ 3 ಕಂತುಗಳಲ್ಲಿ'],
            documents: ['ಆధಾರ್ ಕಾರ್ಡ್', 'ಪಟ್ಟಾದಾರ್ ಪಾಸ್‌ಬುಕ್ / CCRC ಕಾರ್ಡ್', 'ಬ್ಯಾಂಕ್ ಪಾಸ್‌ಬುಕ್']
          },
          'rythu-bandhu': {
            title: 'ರೈತು ಬಂಧು ಯೋಜನೆ (ತೆಲಂಗಾಣ)',
            overview: 'ತೆಲಂಗಾಣದ ರೈತರಿಗೆ ಬೆಳೆ ಹೂಡಿಕೆ ಸಹಾಯವಾಗಿ ಎಕರೆಗೆ ವರ್ಷಕ್ಕೆ ₹10,000 ಆರ್ಥಿಕ ನೆರವು.',
            eligibility: ['ತೆಲಂಗಾಣದ ಎಲ್ಲಾ ಪಟ್ಟಾದಾರ ರೈತರು'],
            benefits: ['ಎಕರೆಗೆ ಮುಂಗಾರಿನಲ್ಲಿ ₹5,000 + ಹಿಂಗಾರಿನಲ್ಲಿ ₹5,000 ನೇರ ಬ್ಯಾಂಕ್ ಜಮಾ'],
            documents: ['ತೆಲಂಗಾಣ ಪಟ್ಟಾದಾರ್ ಪಾಸ್‌ಬುಕ್', 'ಆಧಾರ್ ಕಾರ್ಡ್', 'ಬ್ಯಾಂಕ್ ಖಾತೆ ವಿವರಗಳು']
          }
        },
        shops: {
          's1': { name: 'ಶ್ರೀ ಲಕ್ಷ್ಮಿ ಅಗ್ರಿ ಇನ್‌ಪುಟ್ಸ್ & ಫರ್ಟಿಲೈಸರ್ ಸ್ಟೋರ್', address: 'ಮುಖ್ಯ ರಸ್ತೆ, APMC ಮಾರುಕಟ್ಟೆ ಹತ್ತಿರ, ಗುಂಟೂರು, AP 522001' },
          's2': { name: 'ಕಿಸಾನ್ ಕ್ರಾಪ್ ಪ್ರೊಟೆಕ್ಷನ್ & ಪೆಸ್ಟಿಸೈಡ್ಸ್ ಸೆಂಟರ್', address: 'ಸ್ಟೇಷನ್ ರಸ್ತೆ, ಗುಂಟೂರು, AP 522002' },
          's3': { name: 'ರೈತು ಸೇವಾ ಕೇಂದ್ರಮ್ & ಫಾರ್ಮ್ ಇಕ್ವಿಪ್‌ಮೆಂಟ್ ಸ್ಟೋರ್', address: 'RTC ಬಸ್ સ્ટેಂಡ್ ಕಾಂಪ್ಲೆಕ್ಸ್, ಗುಂಟೂರು, AP 522001' },
          's4': { name: 'ಜೈ ಕಿಸಾನ್ ಆರ್ಗ್ಯಾನಿಕ್ ಫರ್ಟಿಲೈಸರ್ಸ್ & ಸೀಡ್ಸ್ ಡಿಪೋ', address: 'ಏನಾಮಾಮುಲ ಮಾರುಕಟ್ಟೆ ರಸ್ತೆ, ವರಂಗಲ್, TS 506002' },
          's5': { name: 'ಕಾವೇರಿ ಅಗ್ರಿ ಟೆಕ್ & ಡ್ರಿಪ್ ಇಕ್ವಿಪ್‌ಮೆಂಟ್', address: 'APMC ಯಾರ್ಡ್ ಗೇಟ್, ಕೋಲಾರ, KA 563101' }
        }
      }
    }
  },
  ml: {
    translation: {
      ...
      market: {
        ...
        searchCrop: 'വിള തിരയുക (ഉദാ: നെല്ല്, തക്കാളി, മുളക്)...',
      ...
      // Data translation maps (Malayalam Script)
      data: {
        states: {
        ...
        weatherAlerts: [
          { title: 'മിതമായ മഴ മുന്നറിയിപ്പ്', description: 'അടുത്ത 24 മണിക്കൂറിൽ മഴയ്ക്ക് സാധ്യതയുണ്ട്. മരുന്ന് തളിക്കുന്നത് നിർത്തുക.' },
          { title: 'അനുയോജ്യമായ മണ്ണിലെ ഈർപ്പം', description: 'നിലവിലെ ഈർപ്പം (78%) നെൽക്കൃഷിക്കും മുളക് തൈകളുടെ വളർച്ചയ്ക്കും അനുയോജ്യമാണ്.' }
        ],
        schemes: {
          'pm-kisan': {
            ...
            eligibility: ['ഇന്ത്യയിലുടനീളമുള്ള കൃഷിഭൂമിയുള്ള എല്ലാ കർഷക കുടുംബങ്ങളും യോഗ്യരാണ്'],
            benefits: ['പ്രതിവർഷം ₹6,000 നേരിട്ട് ബാങ്ക് അക്കൗണ്ടിൽ (₹2,000 വീതം 3 ഗഡുക്കൾ)', 'സുതാര്യമായ DBT കൈമാറ്റം'],
            documents: ['ആധാർ കാർഡ്', 'ഭൂമി ഉടമസ്ഥാവകാശ രേഖകൾ (കരമടച്ച രസീത്)', 'ആധാറുമായി ബന്ധിപ്പിച്ച ബാങ്ക് അക്കൗണ്ട്', 'ഫോൺ നമ്പർ']
          },
          'pmfby': {
            title: 'പ്രധാൻ മന്ത്രി ഫസൽ ബീമാ യോജന (PMFBY)',
            overview: 'പ്രകൃതിദുരന്തങ്ങൾ മൂലമുള്ള വിളനാശത്തിന് സമഗ്രമായ വിള ഇൻഷുറൻസ് സംരക്ഷണം.',
            eligibility: ['വിജ്ഞാപനം ചെയ്ത പ്രദേശങ്ങളിൽ കൃഷി ചെയ്യുന്ന എല്ലാ കർഷകരും യോഗ്യരാണ്'],
            benefits: ['കുറഞ്ഞ പ്രീമിയം: ഖരീഫ് 2%, റബി 1.5%, വാണിജ്യ വിളകൾ 5%', 'ബാക്കി പ്രീമിയം സർക്കാർ വഹിക്കും'],
            documents: ['ഭൂമി രേഖകൾ', 'വിളവിത്ത് നടീൽ സർട്ടിഫിക്കറ്റ്', 'ആധാർ കാർഡും ബാങ്ക് പാസ്ബുക്കും', 'ക്യാൻസൽ ചെയ്ത ചെക്ക്']
          },
          'kcc': {
            ...
            eligibility: ['വ്യക്തിഗത കർഷകർ / പാട്ടക്കർഷകർ', 'സ്വയം സഹായ സംഘങ്ങൾ (SHG)'],
            benefits: ['₹3 ലക്ഷം വരെയുള്ള വായ്പകൾക്ക് 7% ഇളവ് പലിശ നിരക്ക്', 'കൃത്യസമയത്ത് തിരിച്ചടച്ചാൽ 3% അധിക പലിശ സബ്‌സിഡി', '₹1.6 ലക്ഷം വരെ ഈടില്ലാത്ത വായ്പ'],
            documents: ['അപേക്ഷാ ഫോം', 'തിരിച്ചറിയൽ രേഖ (ആധാർ/വോട്ടർ ഐഡി)', 'വിലാസവും ഭൂമി രേഖകളും', 'പാസ്‌പോർട്ട് സൈസ് ഫോട്ടോ']
          },
          'pmksy': {
            ...
            eligibility: ['ജലസ്രോതസ്സുള്ള കൃഷിഭൂമിയുടമകളായ കർഷകർ'],
            benefits: ['ചെറുകിട കർഷകർക്ക് 55% മറ്റിതര കർഷകർക്ക് 45% സബ്‌സിഡി', '30-50% ജലലാഭം'],
            documents: ['ഭൂമി ഉടമസ്ഥാവകാശ രേഖകൾ', 'ജലസ്രോതസ്സ് തെളിവ്', 'ആധാറും ബാങ്ക് വിവരങ്ങളും']
          },
          'mky': {
            ...
            eligibility: ['വനിതാ കർഷകർ, വനിതാ സ്വയംസഹായ സംഘങ്ങൾ (SHG)'],
            benefits: ['ജൈവകൃഷിയിൽ 100% സൗജന്യ പരിശീലനം', 'വനിതാ സംഘങ്ങൾക്ക് സാമ്പത്തിക സഹായം'],
            documents: ['ആധാർ കാർഡ്', 'SHG അംഗത്വ കാർഡ്', 'ബാങ്ക് അക്കൗണ്ട് വിവരങ്ങൾ']
          },
          'didf': {
            ...
            eligibility: ['ക്ഷീര സഹകരണ സംഘങ്ങൾ, പാൽ ഉൽപാദക കമ്പനികൾ'],
            benefits: ['6.5% കുറഞ്ഞ പലിശ നിരക്കിൽ വായ്പ', 'ഗ്രാമപ്രദേശങ്ങളിൽ പാൽ ശീതീകരണ കേന്ദ്രങ്ങൾ'],
            documents: ['സംഘം രജിസ്ട്രേഷൻ സർട്ടിഫിക്കറ്റ്', 'പ്രോജക്ട് റിപ്പോർട്ട് (DPR)', 'ബാങ്ക് അക്കൗണ്ട് വിവരങ്ങൾ']
          },
          'pmmsy': {
            ...
            eligibility: ['മത്സ്യത്തൊഴിലാളികൾ, മത്സ്യകർഷകർ, സഹകരണ സംഘങ്ങൾ'],
            benefits: ['ജനറൽ വിഭാഗത്തിന് 40% വും SC/ST/വനിതകൾക്ക് 60% വും ധനസഹായം', '₹5 ലക്ഷം വരെ അപകട ഇൻഷുറൻസ്'],
            documents: ['ആധാർ കാർഡ്', 'മത്സ്യബന്ധന ലൈസൻസ്/ഭൂമി രേഖകൾ', 'ബാങ്ക് വിവരങ്ങൾ']
          },
          'rythu-bharosa': {
            ...
            eligibility: ['ആന്ധ്രയിലെ ഭൂമിയുള്ള കർഷകരും രജിസ്റ്റർ ചെയ്ത പാട്ടക്കർഷകരും'],
            benefits: ['പ്രതിവർഷം ₹13,500 ധനസഹായം 3 ഗഡുക്കളായി'],
            documents: ['ആധാർ കാർഡ്', 'പട്ടാദാർ പാസ്ബുക്ക് / CCRC കാർഡ്', 'ബാങ്ക് പാസ്ബുക്ക്']
          },
          'rythu-bandhu': {
            title: 'ൈരതു ബന്ധു പദ്ധതി (തെലങ്കാന)',
            overview: 'തെലങ്കാനയിലെ കർഷകർക്ക് പ്രതിവർഷം ഏക്കറിന് ₹10,000 വിള നിക്ഷേപ സഹായം.',
            eligibility: ['തെലങ്കാനയിലെ എല്ലാ പട്ടാദാർ കർഷകരും'],
            benefits: ['ഏക്കറിന് ഖരീഫിൽ ₹5,000 + റബിയിൽ ₹5,000 നേരിട്ട് ബാങ്ക് അക്കൗണ്ടിലേക്ക്'],
            documents: ['തെലങ്കാന പട്ടാദാർ പാസ്ബുക്ക്', 'ആധാർ കാർഡ്', 'ബാങ്ക് അക്കൗണ്ട് വിവരങ്ങൾ']
          }
        },
        shops: {
          's1': { name: 'ശ്രീ ലക്ഷ്മി അഗ്രി ഇൻപുട്സ് & ഫെർട്ടിലൈസർ സ്റ്റോർ', address: 'മെയിൻ റോഡ്, APMC മാർക്കറ്റിന് സമീപം, ഗുണ്ടൂർ, AP 522001' },
          's2': { name: 'കിസാൻ ക്രോപ്പ് പ്രൊട്ടക്ഷൻ & പെസ്റ്റിസൈഡ്സ് സെന്റർ', address: 'സ്റ്റേഷൻ റോഡ്, ഗുണ്ടൂർ, AP 522002' },
          's3': { name: 'റൈതു സേവാ കേന്ദ്രം & ഫാം എക്വിപ്മെന്റ് സ്റ്റോർ', address: 'RTC ബസ് സ്റ്റാൻഡ് കോംപ്ലക്സ്, ഗുണ്ടൂർ, AP 522001' },
          's4': { name: 'ജയ് കിസാൻ ഓർഗാനിക് ഫെർട്ടിലൈസേഴ്സ് & സീഡ്സ് ഡിപ്പോ', address: 'ഏനാമാമുല മാർക്കറ്റ് റോഡ്, വാറങ്കൽ, TS 506002' },
          's5': { name: 'കാവേരി അഗ്രി ടെക് & ഡ്രിപ്പ് എക്വിപ്മെന്റ്', address: 'APMC യാർഡ് ഗേറ്റ്, കോലാർ, KA 563101' }
        }
      }
    }
  }
